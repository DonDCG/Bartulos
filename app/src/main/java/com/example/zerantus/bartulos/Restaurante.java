...
public class Restaurante extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulo = (TextView) findViewById(R.id.mResTitulo);
        descripcion = (TextView) findViewById(R.id.mTextResInfo);
        img = (ImageView) findViewById(R.id.mImgRes);
        llamada = (Button) findViewById(R.id.mBtnLlamarRes);
        ...
        mMap = (MapFragment) getFragmentManager().findFragmentById(R.id.mMapRes);
